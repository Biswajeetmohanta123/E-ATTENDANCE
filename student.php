...
if(isset($_POST['update'])){
    ...
    $rollno = $dep.sprintf('%03d',$roll);
        ...
        if($con->connect_error){
            ...
            $edt = "UPDATE student SET course='$dep',
            batch='$batch',name='$name',email='$email',contact='$mobile',
            roll_no='$rollno',image='$folder' WHERE id=$id";
        }
...
<body>
    ...
    <input type ="hidden" name="id" placeholder="ID" value="<?php echo $id;?>">
        ...
        <div class="input-field">
            <i class="bi bi-person-circle"></i>
            <input type="text" placeholder="Enter Roll No." name="roll" required value="<?php echo $rollno; ?>">
        </div>
        <div class="input-field">
...
if(isset($_POST['submit'])){
    ...
    $allow_extension = array("jpg","png","jpeg","JPG");
        ...
        if($con->connect_error){
            ...
            $sql = "INSERT INTO student(course, batch, name, email, contact, roll_no, image) VALUES 
            ('$dep','$batch','$name','$email','$mobile','$rollno','$folder')";
        }
